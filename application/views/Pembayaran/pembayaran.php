			...
			<div class="col">
				...
				<div class="form-row">
        			<div class="form-grup col-md-16">
        			    NISN <input type="text" readonly="" name="nisn" value="<?= $siswa->nisn ?>" class="form-control"> 
        			</div> <br>
								
        			<div class="form-grup col-md-16">
        			    NIS <input type="text" readonly="" name="nis" value="<?= $siswa->nis ?>" class="form-control">
        			</div> <br>
								
        			<div class="form-grup col-md-16">
        			    NAMA <input type="text" readonly="" name="nama" value="<?= $siswa->nama ?>" class="form-control">
        			</div> <br>
				<div>
				<div class="form-row">			
        			<div class="form-grup col-md-16">      
        			    ALAMAT <input type="text" readonly="" name="alamat" value="<?= $siswa->alamat ?>" class="form-control">
        			</div><br>
								
        			<div class="form-grup col-md-16">      
        			    NO. TELP <input type="text" readonly="" name="no_telp" value="<?= $siswa->no_telp ?>" class="form-control">
        			</div><br>
								
        			<div class="form-grup col-md-16">
        			    KOMPETENSI KEAHLIAN <input type="text" readonly="" name="kelas" value="<?= $siswa->nama_kelas.' '.$siswa->kompetensi_keahlian?>" class="form-control">
        			</div><br> <br><br>
					
					<div class="form-grup col-md-16"><br>
						<?= $spp;?>
        			</div><br> <br>																	
				</div>
				</center>
				...
				<div class="container">
					<?php 
						...
						<?php
							...
							<form method="post" action="<?= site_url('C_pembayaran/Proses_Bayar_SPP') ?>">
